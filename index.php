    ...
    <body class="body_index">
        ...
        <main class="container-fluid">
            <div class="index_flex">
                ...
                <div class="slideshow">
                    <ul>
                        <li><img src="Medias/Transat/img1.jpg" alt="" width="350" height="200"  /></li>
	                    <li><img src="Medias/Transat/img2.jpg" alt="" width="350" height="200"  /></li>
	                    <li><img src="Medias/Transat/img3.jpg" alt="" width="350" height="200"  /></li>
                    </ul>
                </div>
